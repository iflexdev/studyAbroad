        ...
        <div className="flex flex-col gap-y-4">
          <div className="grid grid-rows-1 grid-cols-[auto_auto] justify-start items-start h-[82px] gap-x-5">
            ...
            <div className="flex-col gap-y-3.5 flex">
              <p id={card.university_id} className="font-semibold text-lg capitalize line line-clamp-2 cursor-pointer" onClick={() => navigate("../university-detail")}>
          ...
          {card?.intakes != 'null' &&
            <div className="">
              ...
              <div className="grid grid-cols-3 gap-4 mt-3">
                {intake?.low && <div className="flex flex-col text-center gap-y-1 ">
                  <p className="text-gray-400 text-[13.46px]">{intake?.low?.[0] + " " + intake?.low?.[1]}</p>
                ...
                {intake?.medium &&
                  <div className="flex flex-col text-center gap-y-1 ">
                    <p className="text-gray-400 text-[13.46px]">{intake?.medium?.[0] + " " + intake?.medium?.[1]}</p>
                    <div className="w-full text-center py-1 text-xs bg-green-100">
                      High
                    </div>
                  </div>
                }
                {intake?.high && <div className="flex flex-col text-center gap-y-1 ">
                  <p className="text-gray-400 text-[13.46px]">{intake?.high?.[0] + " " + intake?.high?.[1]}</p>
                  <div className="w-full text-center py-1 text-xs bg-green-100">
                    Very High
                  </div>
                </div>
